...
<kds:form action="addCustomerSignUpDataToDB" commandName="customerObj" method="post" enctype="multipart/form-data">
...
Name
<kds:input path="customerName" placeholder="Enter Name" required="required"/>
...
<br>Password<kds:password path="userdetails.password" pathholder="Create password"/>
