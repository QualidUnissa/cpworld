...
<div class="col-sm-3 zoom-effect-container" style="background-color:transparent; border-style:none; left-padding:5px;">
		<div class="thumbnail image-card" style="height:370px;border:3px;background-color:transparent; border-radius:8px; padding:5px; border-style: none;"> 
		 <img id="boxshadow" src="resources/images/products/${prdata.productid}.jpg" style="width:320px; height:200px;" class="img-rounded"/>
		<!--  <p class="c1"><br> -->
